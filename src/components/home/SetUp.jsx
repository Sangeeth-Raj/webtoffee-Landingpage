    ...
    return (
        <>
            <SectionContent
                ...
                firstpara="GDPR Cookie Consent & Compliance Notice when installed and activated will add an ADA Compliant cookie banner on your website until visitors accept or reject cookies. he cookie banner can be used to inform the user about the use of cookies and prompt them to take explicit and informed action (accept, reject, or partially accept). This helps you in complying with multiple privacy laws like – GDPR (DSGVO, RGPD), LGPD of Brazil, CCPA Do Not Sell, CNIL of France, and POPIA of South Africa."
